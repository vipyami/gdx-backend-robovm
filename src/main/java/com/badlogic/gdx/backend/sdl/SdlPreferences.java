...
public class SdlPreferences implements Preferences {
	private final String name;
	private final Properties properties = new Properties();
	private final FileHandle file;

	public SdlPreferences (String name) {
		this(new SdlFileHandle(new File(".prefs/" + name), FileType.External));
	}

	public SdlPreferences (FileHandle file) {
		this.name = file.name();
		this.file = file;
